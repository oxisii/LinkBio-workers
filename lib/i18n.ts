...
const en: Dict = {
  ...
  "admin.page.linksNew": "New link",
  "admin.page.linksEdit": "Edit link",
  ...
  "admin.overview.subtitle": "Traffic and what’s on the public page.",
  ...
  "admin.profile.subtitle": "Name, avatar, and bio on the public page.",

  // Links form
  "admin.links.title": "Links",
  "admin.links.subtitle": "Each row is one public link. Open a row to edit.",
  "admin.links.empty": "No links yet.",
  ...
  "admin.theme.subtitle": "Public page skin, colors, and footer.",
  ...
  // Data
  "admin.data.title": "Import / export",
  "admin.data.subtitle": "Local JSON and optional remote backup.",
  "admin.data.hint":
...
const zhCN: Dict = {
  ...
  "admin.nav.menu": "菜单",
  "admin.nav.close": "关闭",
  "admin.nav.account": "账号",
  "admin.nav.appearance": "外观",
  "admin.page.overview": "概览",
  "admin.page.profile": "资料",
  "admin.page.links": "链接",
  "admin.page.linksNew": "新建链接",
  "admin.page.linksEdit": "编辑链接",
  "admin.page.theme": "主题",
  "admin.page.data": "数据",
  "admin.stats.empty": "—",
  "admin.links.urlPlaceholder": "https://",
  ...
  "admin.overview.subtitle": "浏览量，以及当前前台展示的内容。",
  ...
  "admin.profile.subtitle": "前台展示的名称、头像和简介。",

  "admin.links.title": "链接",
  "admin.links.subtitle": "一行一条前台链接。点进去编辑。",
  "admin.links.empty": "暂无链接。",
  ...
  "admin.theme.subtitle": "前台皮肤、配色和页脚。",
  ...
  "admin.data.title": "导入 / 导出",
  "admin.data.subtitle": "本地 JSON，以及可选的远端备份。",
  "admin.data.hint":
